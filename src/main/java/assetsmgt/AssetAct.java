...
public class AssetAct {
    ...
    public int recordAssetActivity(){
        try{
            ...
            PreparedStatement stmt = conn.prepareStatement("INSERT INTO assets (asset_id, activity_date, activity_description, tent_start, tent_end, act_start, act_end, cost, status) " +
            ...
            stmt.setString(6, act_start);
            stmt.setString(7, act_end);
    ...
    public int getRecordableAssets(){
        return 0;
    }
}
